...
Se a issue tratar de uma história do Backlog do Produto, seu título deve ser o código da história mais a descrição desta.

### 3.2 Política de Branches

#### 3.2.1 Repositório de Código
...
#### 3.2.2 Repositório de Documentação
